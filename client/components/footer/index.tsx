      ...
      <div className="container relative border-t-[1px] ">
        <div className="absolute inset-x-0 flex items-center justify-center -top-3">
          <div className="relative flex justify-center h-10 w-14">
            <div className="absolute w-full h-full inset-0 -top-3 blur-[6px] bg-slate-50 rounded-full"></div>
            <Image
              className="block relative -top-2.5"
              src="/mlogo.png"
              width={220}
              height={80}
        ...
        <div className="mx-auto container py-10">
          <div className="sm:relative flex flex-col items-center gap-2 lg:flex-row sm:justify-between">
            <span className="text-sm text-gray-500">
              کليه حقوق محصولات و محتوای اين سایت متعلق به همتانا می باشد
            </span>
