    ...
    <div className="flex flex-col items-center px-24">
      <div className="container relative border-t-[1px] ">
        <div className="mx-auto container py-5">
          <div className="sm:relative flex flex-col items-center gap-2 lg:flex-row sm:justify-between mx-8">
            <span className="text-sm text-gray-500">
              پشتیبانی : 09336901751
            </span>
        ...
        <div className="mx-auto container py-5 bg-red-500 rounded-2xl">
          <div className="sm:relative flex flex-col items-center gap-2 lg:flex-row sm:justify-between mx-7">
            <span className="text-sm text-gray-500">
              پشتیبانی : 09336901751
            </span>
            <ul className="flex items-center justify-end gap-8">
